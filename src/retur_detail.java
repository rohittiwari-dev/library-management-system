 ...
 * @author ASUS
 */
public class retur_detail extends javax.swing.JFrame {
    ...
    {
        try {
            String ur="Select bookid,bookname,edition,studntid,sname,course,issuedate,returndate,returnon,fine from return_book ";
    ...
    public void returnexport(String path)
    {
        ...
        map.put("0", new Object[]{model1.getColumnName(0),model1.getColumnName(1),model1.getColumnName(2),
            ...
            model1.getColumnName(7),model1.getColumnName(8),model1.getColumnName(9)});
        for (int i = 0; i < model.getRowCount(); i++) {
            ...
            model1.getValueAt(i,7),model1.getValueAt(i,8),model1.getValueAt(i,9)});
        }
        ...
        Cell cell8=rs.getCell(8);
        cell8.setCellStyle(style);
        Cell cell9=rs.getCell(9);
        cell9.setCellStyle(style);
        for(int a=0;a<cell9.toString().length();a++)
            ws.autoSizeColumn(a);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Id", "Book Name", "Edition", "Student Id", "Student Name", "Course", "Issue Date", "Return Date", "Returned on", "Fine Taken"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, 1080, 190));
        ...
        getContentPane().add(jTextField10, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 379, 300, 30));
        ...
        jTextField8.setSelectionColor(new java.awt.Color(200, 96, 253));
        getContentPane().add(jTextField8, new org.netbeans.lib.awtextra.AbsoluteConstraints(252, 382, 305, 30));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 650, 230, 40));
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 650, 180, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/return_details.jpg"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else
        {
            ...
            if(jComboBox1.getSelectedItem()=="Book Id")
                ...
                select="studntid";
            String url="Select bookid,bookname,edition,studntid,sname,course,issuedate,returndate,returnon,fine from return_book where "+select+"=?";
            int flag=0;
            try {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField8.setText("Rs. "+model.getValueAt(selectedindx, 9).toString());
        jTextField9.setText(model.getValueAt(selectedindx, 7).toString());
        jTextField10.setText(model.getValueAt(selectedindx, 8).toString());
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        else
        {
            ...
            file.setDialogTitle("Export Return Book Details");
            FileNameExtensionFilter filter =new FileNameExtensionFilter("*.File","xls", "xlsx", "xlsm");
            file.setFileFilter(filter);
            SimpleDateFormat s=new SimpleDateFormat("yyyyMMdd");
            file.setSelectedFile(new File("Return_Book_Details_"+s.format(new Date())));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(retur_detail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new retur_detail().setVisible(true);
            }
        });
    }
