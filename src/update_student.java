...
public class update_student extends javax.swing.JFrame {
    ...
    public update_student() {
        initComponents();
        super.setTitle("Library Management System-Update Student");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 220, -1, 30));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 270, -1, 30));
        ...
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 320, -1, 30));

        jRadioButton4.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jRadioButton4.setForeground(new java.awt.Color(153, 0, 51));
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 370, -1, 30));
        ...
        getContentPane().add(jRadioButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 420, -1, 30));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 490, 130, 40));

        jButton1.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/update_-student.png"))); // NOI18N
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 490, 210, 40));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/update_student.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            String url="UPDATE add_student SET sname='"+jTextField2.getText()+"', fname='"+jTextField3.getText()+"', branch='"+jTextField4.getText()+"', course='"+jTextField5.getText()+"',semester='"+jTextField6.getText()+"' WHERE studentid=?";
            try {
                ps=conn.prepareStatement(url);
                ps.setString(1, jTextField1.getText());
                ps.executeUpdate();
                JOptionPane.showMessageDialog(rootPane, "Student Details Updated on Id: "+jTextField1.getText());
                jTextField1.setText("");
                jTextField2.setText("");
                jTextField3.setText("");
                jTextField4.setText("");
