...
ResultSet rs;
    ...
    public delete_book() {
        initComponents();
        super.setTitle("Library Management System-Delete Book");
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/delete-book.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/delete_book.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            String url="Delete from add_book WHERE bookid=?";
            try {
                ps=conn.prepareStatement(url);
                ps.setString(1, jTextField1.getText());
                ps.execute();
                JOptionPane.showMessageDialog(rootPane, "Book with this Id: "+jTextField1.getText()+" is Deleted on Your Request");
                jTextField1.setText("");
                jTextField2.setText("");
                jTextField3.setText("");
                jTextField4.setText("");
