 ...
 * @author ASUS
 */
public class exp_book extends javax.swing.JFrame {
    ...
    public exp_book() {
        ...
        super.setTitle("Library Management System-Book Details");
    ...
    {
        try {
            String ur="Select bookid,bookname,publication,edition,page,quantity from add_book";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Id", "Book Name", "Publication", "Edition", "Pages", "Quantity"
            }
        ) {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/Books_details.jpg"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else
        {
            ...
            jTextField5.setText("");
            jTextField6.setText("");
            String url="Select bookid,bookname,publication,edition,page,quantity from add_book where bookid=?";
            int flag=0;
            try {
                ...
                if(flag!=1)
                {
                    JOptionPane.showMessageDialog(rootPane, "No Book info. available with This Id");
                }
            } catch (Exception e) {
            }
            finally
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        else
        {
            ...
            file.setDialogTitle("Export Book Details");
            FileNameExtensionFilter filter =new FileNameExtensionFilter("*.File","xls", "xlsx", "xlsm");
            file.setFileFilter(filter);
            SimpleDateFormat s=new SimpleDateFormat("yyyyMMdd");
            file.setSelectedFile(new File("Book_Details_"+s.format(new Date())));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(exp_book.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
