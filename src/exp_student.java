 ...
 * @author ASUS
 */
public class exp_student extends javax.swing.JFrame {
    ...
    public exp_student() {
        ...
        super.setTitle("Library Management System-Student Details");
        ImageIcon im =new ImageIcon("Assets//icon.png");
        super.setIconImage(im.getImage());
        jLabel18.setText(new SimpleDateFormat("dd-MM-yyyy").format(new Date()));
        fetch_issue();
    }
    ...
    {
        try {
            String ur="Select studentid,sname,fname,branch,course,semester from add_student";
    ...
    public void returnexport(String path)
    {
        ...
        map.put("0", new Object[]{model1.getColumnName(0),model1.getColumnName(1),model1.getColumnName(2),
            model1.getColumnName(3),model1.getColumnName(4),model1.getColumnName(5)});
        for (int i = 0; i < model.getRowCount(); i++) {
            map.put(Integer.toString(i+1), new Object[]{model1.getValueAt(i,0),model1.getValueAt(i,1),model1.getValueAt(i,2),
            model1.getValueAt(i,3),model1.getValueAt(i,4),model1.getValueAt(i,5)});
        }
        ...
        for(int a=0;a<cell5.toString().length();a++)
            ws.autoSizeColumn(a);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 110, 150, 35));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student Id", "Student Name", "Father's Name", "Branch", "Course", "Semester"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 305, 990, 200));
        ...
        getContentPane().add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 112, 360, 32));
        ...
        getContentPane().add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 160, 275, 30));
        ...
        getContentPane().add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 200, 275, 30));
        ...
        getContentPane().add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 242, 275, 30));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 160, 270, 32));
        ...
        getContentPane().add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 200, 270, 30));
        ...
        getContentPane().add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 242, 270, 30));
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 530, 180, 40));
        ...
        getContentPane().add(jButton8, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 530, 230, 40));

        jLabel18.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(0, 51, 153));
        jLabel18.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        getContentPane().add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 110, 210, 30));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/Student_details.jpg"))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else
        {
            ...
            jTextField5.setText("");
            jTextField6.setText("");
            String url="Select studentid,sname,fname,branch,course,semester from add_student where studentid=?";
            int flag=0;
            try {
                ...
                if(flag!=1)
                {
                    JOptionPane.showMessageDialog(rootPane, "No Student info. available with This Id");
                }
            } catch (Exception e) {
            }
            finally
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        else
        {
            ...
            file.setDialogTitle("Export Student Details");
            FileNameExtensionFilter filter =new FileNameExtensionFilter("*.File","xls", "xlsx", "xlsm");
            file.setFileFilter(filter);
            SimpleDateFormat s=new SimpleDateFormat("yyyyMMdd");
            file.setSelectedFile(new File("exp_student"+s.format(new Date())));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(exp_student.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new exp_student().setVisible(true);
            }
        });
    }
