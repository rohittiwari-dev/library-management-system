...
ResultSet rs;
    ...
    public update_book() {
        initComponents();
        super.setTitle("Library Management System-Update Book");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 190, 130, 30));
        ...
        getContentPane().add(jRadioButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 440, -1, 30));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 290, -1, 30));
        ...
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 340, -1, 30));
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 390, -1, 30));
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 243, -1, 30));

        jButton1.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/update-book.png"))); // NOI18N
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 510, 180, 40));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 510, 130, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/update_book.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            String url="Select bookname,publication,edition,page,quantity from add_book where bookid=?";
            try {
                ...
                {
                    JOptionPane.showMessageDialog(rootPane, "No Book Registered with this Book ID: "+jTextField1.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            String url="UPDATE add_book SET bookname='"+jTextField2.getText()+"', publication='"+jTextField3.getText()+"', edition='"+jTextField4.getText()+"', page='"+jTextField5.getText()+"',quantity='"+jTextField6.getText()+"' WHERE bookid=?";
            try {
                ps=conn.prepareStatement(url);
                ps.setString(1, jTextField1.getText());
                ps.executeUpdate();
                JOptionPane.showMessageDialog(rootPane, "Book Details Updated on Id: "+jTextField1.getText());
                jTextField1.setText("");
                jTextField2.setText("");
                jTextField3.setText("");
                jTextField4.setText("");
