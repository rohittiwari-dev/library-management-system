...
{
    int i=0;
    String url="Select sname from add_student where studentid=?";
        try {
            ...
            if(rs.next())
            {
                ...
                JOptionPane.showMessageDialog(rootPane, "Student Id Already Registerd With Student Name: "+rs.getString(1));
                i=1;
            }
            else
            {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/add-student.png"))); // NOI18N
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 490, 180, 40));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 490, 160, 40));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 167, 130, 30));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Assets/add_student.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            try {
                String purl="Insert into add_student (studentid,sname,fname,branch,course,semester) Values(?,?,?,?,?,?) ";
                ...
                ps.execute();
                JOptionPane.showMessageDialog(rootPane, "Student Regidtered with Id: "+jTextField1.getText());
                jTextField1.setText("");
                jTextField2.setText("");
                jTextField3.setText("");
                jTextField4.setText("");
            ...
            } catch (Exception e)
            {
                ...
                if(em.equals("[SQLITE_CONSTRAINT_PRIMARYKEY]  A PRIMARY KEY constraint failed (UNIQUE constraint failed: add_student.studentid)")) {
                    JOptionPane.showMessageDialog(rootPane, "Student Already Registered with this Student Id Please Generate or Enter Other one");
